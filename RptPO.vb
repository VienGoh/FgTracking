...
Public Class RptPO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppSpecialFunction.RptPO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_KetTambahan() As CrystalDecisions.[Shared].IParameterField
        Get
